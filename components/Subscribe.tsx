...
function Subscribe() {
  return (
    <div className="text-center lg:text-left lg:items-start items-center mx-auto lg:mx-0 pt-12 lg:w-[530px] font-normal font-montserrat text-2xl leading-7 tracking-[0.5%]">
